...
class Technology extends React.Component {
	...
	render() {
		return (
			<div className="technology_page_wrapper">
				...
				<div className="block_value_wrapper">
					<div className="container">
						<div className="sub_wrap">
							<h6>BLOCKCHAIN'S VALUE IN TODAY'S INVOICING PROCESS</h6>
							<h1>Centralize all your business processes on a decentralized ledger.</h1>
							<p>Blockchain is disrupting supply chain financing. Being a shared ledger, blockchain allows all parties involved in a transaction to real-time track all the steps along the supply chain journey, boosting credibility among trading partners.</p>
						</div>
				...
				<div className="hybrid_wrapper">
					<div className="container">
						<div className="content_head">
							<h6>HYBRID BLOCKCHAIN & SPECS</h6>
							<h1>⦃param⦄.network is driving a new generation of financial services</h1>
							<p>⦃Param⦄ protocol is a hybrid distributed ledger that mixes the benefits public and private networks with none of the pitfalls, and was specially developed to automate and protect the exchange of documents between enterprises.</p>
						</div>
					...
					<div className="container">
						<div className="main_wrap">
							<div className="content_top">
								<h6>LINKING BLOCKCHAIN TO PI</h6>
								<h1>param.network is the framework under our digital invoicing platform, pi</h1>
							</div>
